...
public class SoundSlider : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        string label = locale.GetLocaleWord("Sound");
        ...
        if (gameManager != null)
        {
            if (GameManager.GetSoundVolume() == null)
            {
                GameManager.SetSoundVolume(100);

            }

            slider.value = GameManager.GetSoundVolume();
        }
        else
        {
    ...
    public void VolumeUpdate()
    {
        ...
        if (gameManager != null)
        {
            GameManager.SetSoundVolume((int)slider.value);
        }
        else
        {
            Debug.LogError("GameManager instance is null!");
